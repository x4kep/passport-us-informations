            ...
            <Grid item xs={12} sm={6} paddingBottom={2}>
              <Box sx={{ display: "flex", alignItems: "end" }}>
                <TextField
                  ...
                  variant="standard"
                  sx={{ minWidth: "250px" }}
                  helperText="Please make sure you enter a valid email address. We will use it to contact you about your application."
                />
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                variant="standard"
                helperText="Please make sure the first name(s) are exactly as shown on your passport or travel document"
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                label="Family name(s)"
                variant="standard"
                helperText="Please make sure the family name(s) are exactly as shown on your passport or travel document."
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
            ...
            <Grid item xs={12} sm={6}>
              <FormControl>
                ...
                >
                  ...
                  >
                    A marriage must be recognized under of law of country where
                    it was performed and under US law.
                  </Popover> */}
                </Box>
                <Box>
                  <NativeSelect
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                variant="standard"
                sx={{ minWidth: "250px" }}
                helperText="If you can't find this listed on your passport, enter the name of the city/town/village where you were born"
              />
              <FormGroup>
                <FormControlLabel
            ...
            <Grid item xs={12} sm={6} paddingBottom={4}>
              <TextField
                ...
                variant="standard"
                sx={{ minWidth: "250px" }}
                helperText="Please choose the country you were born in, as per your travel documents."
              />
            </Grid>
          </Grid>
          <Divider />
